...
RhomScripts.modules.audio = load_module("audio", true)
RhomScripts.modules.modes = load_module("modes", true)
RhomScripts.modules.historial = load_module("historial", true)
RhomScripts.modules.lector = load_module("lector", true)
RhomScripts.modules.listas = load_module("listas", true)
RhomScripts.modules.grupos = load_module("grupos", true)
RhomScripts.modules.comunicaciones = load_module("comunicaciones", true)
RhomScripts.modules.general = load_module("general", true)
RhomScripts.modules.corrector = load_module("corrector", true)
RhomScripts.modules.nicks = load_module("nicks", true)
RhomScripts.modules.eventos = load_module("eventos", true)
RhomScripts.modules.generales = load_module("generales", true)
RhomScripts.modules.stats = load_module("stats", true)
RhomScripts.modules.combate = load_module("combate", true)
RhomScripts.modules.habilidades = load_module("habilidades", true)
RhomScripts.modules.sucesos = load_module("sucesos", true)
RhomScripts.modules.movimiento = load_module("movimiento", true)
RhomScripts.modules.oceano = load_module("oceano", true)
RhomScripts.modules.npcs = load_module("npcs", true)
RhomScripts.modules.emociones = load_module("emociones", true)
RhomScripts.modules.monturas = load_module("monturas", true)
